package com.bank.bian.customerposition.model;
...
/**
 * The BIAN control record for this service domain: "Customer Position Management Plan".
 *
 ...
 * to its asset type (Customer Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Position Management Plan";
